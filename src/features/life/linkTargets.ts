...
export function getPhotoLinkedTargetOptions(date: string, events: CalendarEvent[], tasks: TaskItem[], activities: LifeActivityRecord[]): Array<{ id: string; key: string; label: string; title: string; type: LifeLinkedTarget["type"] }> {
  return [
    ...events
